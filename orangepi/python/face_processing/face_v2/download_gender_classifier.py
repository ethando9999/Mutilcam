...
if __name__ == "__main__":
    ...
    # SAVE_DIRECTORY = "models/prithivMLmods_gender_classifier_mini" # Lưu vào thư mục con tại vị trí chạy code

    MODEL_NAME = "dima806/fairface_gender_image_detection"
    SAVE_DIRECTORY = "models/dima806_fairface_gender_image_detection" # Lưu vào thư mục con tại vị trí chạy code
