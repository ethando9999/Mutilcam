...
from gender_predict import GenderPredictor  # Giả định GenderPredictor được lưu trong file gender_predictor.py
import cv2
import time
import logging
...
MODEL_PATH = "python/face_proccesing/models/model_emotion.rknn"
