...
def worker(task_queue):  # Đổi tên tham số queue thành task_queue
    while True:
        ...
        output_file = f"{output_dir}/frame_{client_id}.webp"  # Tạo file riêng cho mỗi client
        try:
...
def processing_frame(frame):
    # Xử lý tập tin frame va luu frame da xu ly vao hang doi
    #...
    pass
