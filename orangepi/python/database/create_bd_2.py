    ...
    try:
        ...
        async with aiosqlite.connect(db_path) as db:
            ...
            await db.executescript(
                ...
                -- Feature Bank
                ----------------------------------------------------------------
                CREATE TABLE IF NOT EXISTS FeatureBank (
                ...
                CREATE INDEX IF NOT EXISTS idx_featurebank_person
                    ON FeatureBank(person_id);

                -- Trigger giữ tối đa 20 feature vectors mỗi person
                CREATE TRIGGER IF NOT EXISTS trg_limit_featurebank
                ...
                -- FaceID Bank
                ----------------------------------------------------------------
                CREATE TABLE IF NOT EXISTS FaceIDBank (
                ...
                CREATE INDEX IF NOT EXISTS idx_faceidbank_person
                    ON FaceIDBank(person_id);

                -- Trigger giữ tối đa 20 face vectors mỗi person
                CREATE TRIGGER IF NOT EXISTS trg_limit_faceidbank
                ...
                CREATE INDEX IF NOT EXISTS idx_pub_person     ON PublishStatus(person_id);
                CREATE INDEX IF NOT EXISTS idx_pub_status     ON PublishStatus(status);
                CREATE INDEX IF NOT EXISTS idx_pub_time       ON PublishStatus(publish_time);
                """
            )
